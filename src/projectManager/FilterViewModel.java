...
import projectManager.ViewUser;
...
public class FilterViewModel extends PMBindComposer<Component>{
    ...
    public String getProjFooter() {
        return String.format(footerMessage, projectStatuses.size());
    }
    ...
    @Command
    @NotifyChange({"projectStatus","projFooter"})
    public void changeProjFilter(){
    	projectStatuses = ViewProject.getProjectFilter(projectFilter);
    }
    
    public ListModelList<ProjectStatus> getProjectStatus(){
    	return new ListModelList<ProjectStatus>(projectStatuses);
    }
