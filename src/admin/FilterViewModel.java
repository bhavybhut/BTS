...
public class FilterViewModel {
    ...
    public ListModelList<UserStatus> getUserStatus(){
    	return new ListModelList<UserStatus>(userStatuses);
    }
    ...
    private static List<UserStatus> generateStatusList(List<UserStatus> list) {
		List<UserStatus> us = new ArrayList<UserStatus>();
		for(UserStatus u : list) {
			us.add(u);
		}
		return us;
	}
    ...
    public String getFooter() {
        return String.format(footerMessage, userStatuses.size());
    }
 
    @Command
    @NotifyChange({"userStatus", "footer"})
    public void changeFilter() {
    	userStatuses = ViewUser.getFilterUsers(user);
    }
