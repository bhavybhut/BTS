...
public class FilterViewModel implements Composer{
	...
	private List<BugStatus> bugStatuses = generateStatusList(ViewBugs.getAllBugs());
	...
	public String getFooter(){
		return String.format(footerMessage, bugStatuses.size());
	}
	
	public ListModelList<BugStatus> getBugStatus(){
